...
At version `0.1.0`, EveryData, EverySearch, EveryAI, and EverySolve have MCP workflows.
EveryNumber, EveryMail, and EveryProxy are documented as REST-only until live MCP discovery and
parity tests prove otherwise.
